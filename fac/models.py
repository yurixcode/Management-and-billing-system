...
from django.db.models import Sum # Para sumar
...
class FacturaEnc(ClaseModelo2):
    ...
    class Meta:
        ...
        permissions = [
            ('sup_caja_facturaenc', 'Permisos de Supervisor de Caja en encabezado')
        ]
...
@receiver(post_save, sender=FacturaDet) # Recuerda que 'instance' se refiere al modelo dado en el parámetro sender
def detalle_fac_guardar(sender, instance, **kwargs):
    ...
    if enc:
        sub_total = FacturaDet.objects \
            ...
            .get('sub_total', 0.00) # Con el segundo parámetro, estamos estableciendo un valor por defecto si falla la búsqueda
