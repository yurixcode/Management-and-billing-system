...
# Decimos con el siguiente decorador, que la siguiente función se va a disparar cuándo se cumpla la siguiente declaración. (Enviada como parámetros)
#En este caso, se disparará cuándo se borre un registro de 'ComprasDet'
